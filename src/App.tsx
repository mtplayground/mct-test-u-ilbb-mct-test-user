...
export function App() {
  return (
    <main className="app bg-background text-foreground">
      <section className="app__intro" aria-labelledby="app-title">
        ...
        <p>
          The playground foundation is ready for the editor, preview, routing, persistence, and
          sharing features tracked in the remaining issues.
        </p>
      </section>
    </main>
  );
